...
import com.example.mechanic.adapters.ChatAdapter;
import com.example.mechanic.model.Chat;
...
public class SMChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_smchat);
        ...
        reference = FirebaseDatabase.getInstance().getReference("Users").child("Manager").child(userid);
