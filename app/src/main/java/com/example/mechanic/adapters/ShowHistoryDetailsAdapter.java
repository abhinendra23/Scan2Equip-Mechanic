...
public class ShowHistoryDetailsAdapter extends FirebaseRecyclerPagingAdapter<PastRecord, ShowHistoryDetailsAdapter.MyHolder> {
    ...
    public ShowHistoryDetailsAdapter(DatabasePagingOptions<PastRecord> options, Context c) {
        super(options);
        this.c = c;
    }
    ...
    class MyHolder extends RecyclerView.ViewHolder {
        ...
        {
            date.setText(String.valueOf(model.getServiceDate()));
